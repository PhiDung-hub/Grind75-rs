...
mod tests {
    ...
    fn equal_case_1() {
        ...
        assert!(is_subtree(tree1.clone(), tree2.clone()));
        assert!(is_subtree_improved(tree1.clone(), tree2.clone()));
        assert!(is_subtree_iterative_optimized(tree1.clone(), tree2.clone()));
        assert!(is_subtree_builtin(tree1, tree2));
    }
    ...
    fn different_nodes() {
        ...
        assert!(!is_subtree(tree1.clone(), tree2.clone()));
        assert!(!is_subtree_improved(tree1.clone(), tree2.clone()));
        assert!(!is_subtree_iterative_optimized(tree1, tree2));
    }
